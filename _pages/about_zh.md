...
我目前任职于郑州大学计算机与人工智能学院。本人于 2025 年 6 月在郑州大学获得软件工程专业博士学位，导师为 <a href="http://www5.zzu.edu.cn/mlis/"><strong>叶阳东教授</strong></a>。

我的研究兴趣主要包括数据挖掘与机器学习，重点关注推荐系统、多模态学习、信息瓶颈和图表示学习等方向。我的研究目标是面向推荐和图数据分析任务，探索有效、鲁棒且具有一定可解释性的学习方法。
...
<ul class="content-list">
  <li>图传播IB方法的模型及传播机制研究 (62176239) <br> 国家自然科学基金，2022-2025，参与</li>
</ul>

<ul class="content-list">
  <li>传播IB方法的研究 (61772475) <br> 国家自然科学基金，2018-2021，参与</li>
</ul>
